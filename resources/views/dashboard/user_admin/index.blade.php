                                    ...
                                    @foreach ($admins as $admin)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button class="btn btn-danger btn-sm" onclick="hapusData('{{ base64_encode($admin->id) }}')">Hapus</button>
                                            </td>
                                        </tr>
                                        ...
                                        <div class="modal fade" id="editModal-{{ $admin->id }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{ route('user-admin.update', $admin->id) }}" method="post"
                                                                ...
                                                                <div class="col-12">
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <input type="text" class="form-control"
                                                                            ...
                                                                            placeholder="Masukan nama admin" value="{{ $admin->name }}" />
                                                                    </div>
                                                                </div>
                                                                <div class="col-12">
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <input type="email" class="form-control"
                                                                            ...
                                                                            placeholder="Masukan email admin" value="{{ $admin->email }}" />
                                                                    </div>
                                                                </div>
                                                                <div class="col-12">
                                                                    <div class="mb-3">
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    <label for="password" class="form-label">Password <sup
                                            style="font-style: italic">(Optional default: admin)</sup></label>
