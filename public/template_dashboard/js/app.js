        ...
        document.getElementById("header-lang-img") &&
            ("en" == e
                ? (document.getElementById("header-lang-img").src =
                      "/template_dashboard/images/flags/us.jpg")
                : "sp" == e
                ? (document.getElementById("header-lang-img").src =
                      "/template_dashboard/images/flags/spain.jpg")
                : "gr" == e
                ? (document.getElementById("header-lang-img").src =
                      "/template_dashboard/images/flags/germany.jpg")
                : "it" == e
                ? (document.getElementById("header-lang-img").src =
                      "/template_dashboard/images/flags/italy.jpg")
                : "ru" == e &&
                  (document.getElementById("header-lang-img").src =
                      "/template_dashboard/images/flags/russia.jpg"),
            localStorage.setItem("language", e),
            null == (t = localStorage.getItem("language")) && n(s),
            a.getJSON("/template_dashboard/lang/" + t + ".json", function (e) {
                a("html").attr("lang", t),
        ...
        "light-mode-switch" === e
            ? (a("html").removeAttr("dir"),
              ...
              a("#bootstrap-style").attr(
                  "href",
                  "/template_dashboard/css/bootstrap.min.css"
              ),
              a("body").attr("data-layout-mode", "light"),
              a("#app-style").attr("href", "/template_dashboard/css/app.min.css"),
